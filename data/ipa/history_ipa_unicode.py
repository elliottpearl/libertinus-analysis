...
PRECOMPOSED_ANCHOR_RELEVANT = [
    0x00E0, 0x00E1, 0x00E2, 0x00E3, 0x0101, 0x00E5, 0x1EA1, 0x1EB7, 0x1EA7, 
    0x1EAF, 0x1EB1, 0x1EB5, 0x1EA5, 0x1EA7, 0x1EAB, 0x00E8, 0x00E9, 0x00EA, 
    0x1EBD, 0x0113, 0x1EB9, 0x1EC7, 0x1EBF, 0x1EC1, 0x1EC5, 0x00EC, 0x00ED, 
    0x00EE, 0x0129, 0x012B, 0x1ECB, 0x00F2, 0x00F3, 0x00F4, 0x00F5, 0x014D,
    0x1ECD, 0x1ED9, 0x1ED1, 0x1ED3, 0x1ED7, 0x00F9, 0x00FA, 0x00FB, 0x0169, 
    0x016B, 0x1EE5, 0x1EF3, 0x00FD, 0x0177, 0x1EF9, 0x0233, 0x1EF5, 0x1E0D,
    0x1E37, 0x1E47, 0x1E5B, 0x1E63, 0x1E6D, 0x1E93,
]
...
ipa_diacritic_bases = {
    ...
    0x0307: [
        0x006E,0x006C,0x0073,0x007A,0x0273,0x026D,0x0282,0x0290,
    ],
    # U+0303 COMBINING TILDE (creaky voice)
    0x0303: [
        0x0250,0x0251,0x0252,0x025B,0x025C,0x025E,0x0259,0x0258,0x0264,0x026F,
        0x028A,0x028C,0x028F,0x0275,0x0276,0x006C,0x0072,0x0279,0x027A,0x027B,
        0x027C,0x026B,0x026D,0x026E,0x0271,0x0272,0x0273,0x0274,
    ],
    # BELOW MARKS
    # U+032A COMBINING BRIDGE BELOW (dental)
    0x032A: [
        0x0074,0x0064,0x006E,0x0073,0x007A,0x027A,0x0279,0x027B,
    ],
    # U+0329 COMBINING SYLLABIC MARK
    0x0329: [
        0x006C,0x0072,0x006D,0x006E,0x026B,0x026D,0x026E,0x0271,0x0272,0x0273,
        0x0274,
    ],
    # U+0330 COMBINING TILDE BELOW (creaky voice)
    0x0330: [
        0x0250,0x0251,0x0252,0x025B,0x025C,0x025E,0x0259,0x0258,0x0264,0x026F,
        0x028A,0x028C,0x028F,0x0275,0x0276,
    ],
    ...
    0x0323: [
        0x0256,0x0273,0x026D,0x0288,0x0282,0x0290,0x0253,0x0257,0x0260,0x0261,
        0x0262,0x0263,0x0266,0x0265,0x028B,0x0281,0x0280,0x0288,0x0289,0x028A,
        0x028C,0x0259,0x0250,0x0251,0x0252,0x025B,0x025C,0x025E,0x0264,0x026F,
        0x028A,0x028C,0x028F,0x0275, 0x0276,
    ],
}
...
ipa_diacritic_bases = {
    ...
    0x0300: [
        0x0061,0x0065,0x0069,0x006F,0x0075,0x00E6,0x0250,0x0251,0x0252,0x025B,
        0x025C,0x025E,0x0259,0x0258,0x0264,0x026F,0x028A,0x028C,0x028F,0x0275,
        0x0276,0x006D,0x006E,0x006C,0x0272,0x014B,
    ],
    # U+0301 COMBINING ACUTE ACCENT (tone / palatalization)
    0x0301: [
        0x0074,0x0064,0x006E,0x0073,0x007A,0x0255,0x0291,0x006C,0x0072,0x025F,
        0x0261,0x0263,0x0061,0x0065,0x0069,0x006F,0x0075,0x00E6,0x0250,0x0251,
        0x0252,0x025B,0x025C,0x025E,0x0259,0x0258,0x0264,0x026F,0x028A,0x028C,
        0x028F, 0x0275, 0x0276,0x006D,0x006E,0x006C,0x0272,0x014B,
    ],
    ...
    0x0304: [
        0x0061,0x0065,0x0069,0x006F,0x0075,0x00E6,0x0250,0x0251,0x0252,0x025B,
        0x025C,0x025E,0x0259,0x0258,0x0264,0x026F,0x028A,0x028C,0x028F,0x0275,
        0x0276,0x006D,0x006E,0x006C,0x0072,0x0272,0x014B, 
    ],
    # U+030A COMBINING RING ABOVE (voicelessness)
    0x030A: [
        0x006D,0x006E,0x0272,0x014B,0x006C,0x026B,0x026C,0x026E,0x0072,0x0279,
    ...
    0x030B: [
        0x0061,0x0065,0x0069,0x006F,0x0075,0x00E6,0x0250,0x0251,0x0252,0x025B,
        0x025C,0x025E,0x0259,0x028A,0x028C,
    ],
    ...
    0x0323: [
        0x0066,0x0256,0x0273,0x026D,0x0288,0x0282,0x0290,0x0253,0x0257,0x0260,
        0x0261,0x0262,0x0263,0x0266,0x0265,0x028B,0x0281,0x0280,0x0289,0x028A,
        0x028C,0x0061,0x0065,0x0069,0x006F,0x0075,0x0259,0x0250,0x0251,0x0252,
        0x025B,0x025C,0x025E,0x0264,0x026F,0x028A, 0x028C,0x028F,0x0275,0x0276,
    ],
    # U+0325 COMBINING RING BELOW (voiceless, devoiced)
    0x0325: [
        0x0062, 0x0064, 0x0067, 0x0076, 0x007A, 0x0292, 0x006D, 0x006E, 0x006C, 
        0x0072, 0x0077, 0x006A, 0x0271, 0x0272, 0x0273, 0x014B, 
    ],
    ...
    # U+0330 COMBINING TILDE BELOW (creaky voice)
    0x0330: [
        0x0250, 0x0251, 0x0252, 0x025B, 0x025C, 0x025E, 0x0259, 0x0258, 0x0264, 
        0x026F, 0x028A, 0x028C,      0x028F, 0x0275, 0x0276,
    ],
    # U+0333 COMBINING DOUBLE MACRON BELOW (ATR/RTR)
    0x0333: [
        0x0250, 0x0251, 0x0252, 0x025B, 0x025C, 0x025E, 0x0259, 0x0258, 0x0264, 0x026F, 
...
ipa_diacritic_bases = {
    ...
    0x0323: uniq( VOWELS, RETROFLEX_CONSONANTS, EMPHATIC_TRANSLIT, NONCORONAL_OBSTRUENTS),
    # U+0325 RING BELOW (devoicing)
    0x0325: uniq(VOWELS,VOICELESSABLE, NONCORONAL_OBSTRUENTS),
...
base_above_anchor_required = [
    0x00E6,0x0153,0x006D,0x006E,0x006C,0x0072,0x0074,0x0064,0x0073,0x007A,
    0x0255,0x0291,0x025F,0x0261,
    0x0263,0x0250,0x0251,0x0252,0x025B,0x025C,0x025E,0x0259,0x0258,0x0264,
    0x026F,0x028A,0x028C,0x028F,0x0275,0x0276,0x0272,0x014B,0x026B,0x026C,
    0x026E,0x0279,0x027A,0x027B,0x0280,0x0281,0x028B,0x0265,0x028E,0x029D,
    0x029F,
]

base_below_anchor_required = [
    0x00E6,0x0153,0x0250,0x0251,0x0252,0x025B,0x025C,0x025E,0x0259,0x0258,
    0x0264,0x026F,0x028A,0x028C,
    0x028F,0x0275,0x0276,0x0074,0x0064,0x0073,0x007A,0x0288,0x0256,0x0282,
    0x0290,0x0273,0x027D,0x026D,0x0066,0x006B,0x0067,0x0071,0x0078,0x0062,
    0x0076,0x0292,0x006D,0x006E,0x006C,0x0072,0x0077,0x006A,0x0271,0x0272,
    0x014B,0x026B,0x026E,0x0274,0x0070,0x0283,0x0255,0x0063,
]
...
# Broad natural classes useful for rare marks
...
ALL_VOWELS = VOWELS  # already defined
