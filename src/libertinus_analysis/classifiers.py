...
# ----------------------------------------------------------------------
# Classic classifier (RENAMED ONLY)
# ----------------------------------------------------------------------

def classify_combo_classic(base_cp, mark_cp, classIndex, fontctx):
    """
...
def classify_combo_plain(base_cp, mark_cp, classIndex, fontctx):
    ...
    # Copy/paste of sanity classifier, with only the semantic-support
    # block removed and supported=True forced.
